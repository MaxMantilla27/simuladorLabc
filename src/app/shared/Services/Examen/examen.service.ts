...
import { RegistroLabcExamenDTO, RegistroLabcExamenRespuestaDTO } from 'src/app/Models/ExamenDTO';
...
export class ExamenService {
  ...
  public Registrar(Json:RegistroLabcExamenDTO):Observable<any>{
  ...
  public RegistrarRespuestaSeleccion(Json:RegistroLabcExamenRespuestaDTO):Observable<any>{
  ...
  public ObtenerMejorExamenPorUsuario(Json:RegistroLabcExamenDTO):Observable<any>{
