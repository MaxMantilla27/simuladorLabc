...
import { ExamenIntentoDTO, RegistroLabcExamenDTO } from 'src/app/Models/ExamenDTO';
    ...
    this._ExamenService.ListaExamenesIncompletos().subscribe({
      next:(x)=>{
        ...
        this.SimulacionesIncompletas.forEach((y:any)=>{
          if(y.idEstadoExamen!=3 && y.idSimuladorLabcModo==3){
